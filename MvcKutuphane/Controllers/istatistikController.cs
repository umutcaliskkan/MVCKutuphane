...
namespace MvcKutuphane.Controllers
{
    public class istatistikController : Controller
    {
        ...
        [HttpPost]
        public ActionResult resimyukle(HttpPostedFileBase dosya) //Dosya ekleme işlemleri
        {
            if (dosya.ContentLength > 0)
            {
                string dosyayolu = Path.Combine(Server.MapPath("~/web2/resimler/"), Path.GetFileName(dosya.FileName)); //nereye kaydedileceği
